...
module "ec2-instance-private-app3" {
  ...
  user_data =  templatefile("app3-install.tmpl",{rds_db_endpoint = module.db.db_instance_address, rds_db_password = var.db_password })    
