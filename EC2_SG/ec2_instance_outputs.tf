...
output "private_instance_id" {
  ...
  value = [for ec2private in module.ec2module.ec2-instance-private: ec2private.id]
}

output "private_ip" {
  description = "private ip's of private ec2 instances"
  value = [for ec2private in module.module.ec2-instance-private: ec2private.private_ip]
}