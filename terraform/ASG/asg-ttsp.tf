...
resource "aws_autoscaling_policy" "alb_target_requests_greater_than_yy" {
  ...
  target_tracking_configuration {
    predefined_metric_specification {
      ...
      # resource_label =  "${module.alb.target_groups["mytg1"].arn_suffix}"
    }  
    target_value = 10.0
  }    
}

# resource "aws_autoscaling_policy" "avg_cpu_policy_greater_than_xx2" {
#   name                   = "avg-cpu-policy-greater-than-xx2"
#   policy_type = "TargetTrackingScaling" # Important Note: The policy type, either "SimpleScaling", "StepScaling" or "TargetTrackingScaling". If this value isn't provided, AWS will default to "SimpleScaling."    
...
# TTS - Scaling Policy-2: Based on ALB Target Requests
# resource "aws_autoscaling_policy" "alb_target_requests_greater_than_yy2" {
#   name                   = "alb-target-requests-greater-than-yy2"
#   policy_type = "TargetTrackingScaling" # Important Note: The policy type, either "SimpleScaling", "StepScaling" or "TargetTrackingScaling". If this value isn't provided, AWS will default to "SimpleScaling."    
#   autoscaling_group_name = aws_autoscaling_group.asg-app2.id 
#   estimated_instance_warmup = 120 # defaults to ASG default cooldown 300 seconds if not set  
#   # Number of requests > 10 completed per target in an Application Load Balancer target group.
...
#       # Change-2: ALB Module upgraded to 9.4.0 
#       #resource_label =  "${module.alb.lb_arn_suffix}/${module.alb.target_group_arn_suffixes[0]}"    
#       resource_label =  "${module.alb.arn_suffix}/${module.alb.target_groups["mytg2"].arn_suffix}"  # UPDATED 
#     }  
#     target_value = 10.0
#   }    
# }

# resource "aws_autoscaling_policy" "avg_cpu_policy_greater_than_xx3" {
#   name                   = "avg-cpu-policy-greater-than-xx3"
#   policy_type = "TargetTrackingScaling" # Important Note: The policy type, either "SimpleScaling", "StepScaling" or "TargetTrackingScaling". If this value isn't provided, AWS will default to "SimpleScaling."    
...
# # TTS - Scaling Policy-2: Based on ALB Target Requests
# resource "aws_autoscaling_policy" "alb_target_requests_greater_than_yy3" {
#   name                   = "alb-target-requests-greater-than-yy3"
#   policy_type = "TargetTrackingScaling" # Important Note: The policy type, either "SimpleScaling", "StepScaling" or "TargetTrackingScaling". If this value isn't provided, AWS will default to "SimpleScaling."    
#   autoscaling_group_name = aws_autoscaling_group.asg-app3.id 
#   estimated_instance_warmup = 120 # defaults to ASG default cooldown 300 seconds if not set  
#   # Number of requests > 10 completed per target in an Application Load Balancer target group.
...
#       # Change-2: ALB Module upgraded to 9.4.0 
#       #resource_label =  "${module.alb.lb_arn_suffix}/${module.alb.target_group_arn_suffixes[0]}"    
#       resource_label =  "${module.alb.arn_suffix}/${module.alb.target_groups["mytg3"].arn_suffix}"  # UPDATED 
#     }  
#     target_value = 10.0
#   }    
# }
...
# Updated 
output "asg_build_resource_label1" {
  value =  "${module.alb.arn_suffix}/${module.alb.target_groups["mytg1"].arn_suffix}"  
}

# output "asg_build_resource_label2" {
#   value =  "${module.alb.arn_suffix}/${module.alb.target_groups["mytg2"].arn_suffix}"  
# }

# output "asg_build_resource_label3" {
